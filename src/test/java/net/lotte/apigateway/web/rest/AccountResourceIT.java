...
import static net.lotte.apigateway.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static net.lotte.apigateway.test.util.OAuth2TestUtil.authenticationToken;
import static net.lotte.apigateway.test.util.OAuth2TestUtil.registerAuthenticationToken;
