package net.lotte.apigateway.config;
...
import net.lotte.apigateway.security.oauth2.AudienceValidator;
import net.lotte.apigateway.security.oauth2.JwtGrantedAuthorityConverter;
import net.lotte.apigateway.web.filter.SpaWebFilter;
